...
- Use commas, colons, or separate sentences in place of em dashes, and use emojis only when asked; use domain-accurate
  terms; link related tickets as hyperlinks, not plain text
