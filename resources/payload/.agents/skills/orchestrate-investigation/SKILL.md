...
1. Run the fan-out below when the investigation spans genuinely independent areas that are too wide to
   cover yourself, or when the user asked for it. Investigate directly otherwise
