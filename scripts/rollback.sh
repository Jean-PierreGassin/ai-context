...
main() {
  local history_output rollback_output safety_snapshot selected_state snapshot_id
  local restored_snapshot selected_action selected_created selected_remove selected_restore
